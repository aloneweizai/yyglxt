                ...
                <tbody class="pn-ltbody">
                    <#if invoiceRepoRqs?? && ( invoiceRepoRqs?size gt 0 )> 
					  ...
					  <tr>
						 ...
						 <td><a class="ljc_00bcd4" data-type="lookModal" data-val="4" href="javascript:;" data-url="${ctx}/consumerManager/consumer/info.php?id=${invoiceRepo.userId}">${(invoiceRepo.username)!}</a></td>
