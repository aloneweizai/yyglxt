            ...
            <table class="layui-table" lay-size="sm">
                ...
                <#if list?? && (list?size > 0) >
                    ...
                    <tr>
                        ...
                        <td align="center"><a class="ljc_00bcd4" data-type="lookdialog"  data-val="4" href="javascript:;" data-url="${ctx}/consumerManager/consumer/info.php?id=${item.userId}">${(item.username)!}</a></td>
