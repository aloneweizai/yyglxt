...
<div class="g_subheader">
    <div class="g_content">
        <div class="g_content">
            <div class="sub_nav">
                <a class="nav_item current" href="${ctx}/cszjs/msgauto/msgauto_btj.php">被添加自动回复</a>
                        ...
                        <div class="page" data-pid="1" style="display: block;">
                            ...
                            <form name="consumer_edit" action="${ctx}/cszjs/msgauto/msgsave.php"
                                ...
                                <table class="layui-table" lay-size="sm">
                                    <tr>
                                        <td>
                                            ...
                                            <#if msgautoDto??>
                                                ...
                                                <div id="typeDiv">
                                                    &nbsp;&nbsp;&nbsp;<input type="radio" class="status" name="msgType"
                                                                             id="status0"
                                                                             <#if msgautoDto.msgType == '0'>checked="checked"</#if>value="0" title="禁用">
                                                    &nbsp;<input type="radio" class="status" name="msgType" id="status1"
                                                                 <#if msgautoDto.msgType ==  'text'>checked="checked"</#if>
                                                                 value="text" title="文本">
                                                    &nbsp;<input type="radio" class="status" name="msgType" id="status2"
                                                                 <#if msgautoDto.msgType == 'image'>checked="checked"</#if>
                                                                 value="news" title="图文">
                                                </div>
                                                <div id="noDiv" class="noDiv_${msgautoDto.msgType}">
                                                    <div id="articleDiv0">
                                                        <textarea class="layui-textarea"
                                                                  name="summary">［消息自动回复］已禁用，要开启请选择其他选项！</textarea>
                                                    </div>
                                                    <div id="articleDiv1">
                                                        <textarea class="layui-textarea"
                                                                  name="summary"><#if msgautoDto.msgType! == "text">${msgautoDto.content}</#if></textarea>
                                                    </div>
                                                    <div id="articleDiv2">
                                                        <textarea class="layui-textarea"
                                                                  name="summary"><#if msgautoDto.msgType! == "news">${msgautoDto.content}</#if></textarea>
                                                    </div>
                                                </div>
                                            </#if>
                                            </div>
                                    ...
                                    <tr>
                                        <td colspan="3"><input type="button" name="button" id="consumer_submit"
                                                               value="提交" class="layui-btn"></td>
                                    </tr>
                                </table>
                            </form>
                        </div>
...
<script data-main="${ctx}/js/abc/cszj/msgbtj.js" src="${ctx}/js/require.js"></script>
</body>
</html>