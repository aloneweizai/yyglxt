                ...
                <table class="layui-table" lay-size="sm">
                    ...
                    <#if consumers?? && ( consumers?size gt 0 )>
                        ...
                        <tr>
                            ...
                            <td><a class="ljc_00bcd4" data-type="opendialog" data-val="4" href="javascript:;" data-url="${ctx}/consumerManager/consumer/info.php?id=${consumer.id}">${(consumer.username)!}</a></td>
