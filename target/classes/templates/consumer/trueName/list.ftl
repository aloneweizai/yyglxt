                    ...
                    <#if consumers?? && ( consumers?size gt 0 )> 
					  <#list consumers as consumer>
					   <tr>
						 ...
						 <td><a class="ljc_00bcd4" data-type="lookdialog" data-val="4" href="javascript:;" data-url="${ctx}/consumerManager/consumer/info.php?id=${consumer.userId}">${(consumer.username)!}</a></td>
