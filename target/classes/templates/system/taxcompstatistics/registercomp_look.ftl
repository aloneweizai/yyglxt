...
<div class="container-fluid m_top_30 nycol_list  sys_mod">
    <form action="${ctx}/taxcompstatis/registercompcount/detail.php?days=${BaseRq.days!}" method="post" id="consumerListForm" class="layui-form">
            ...
            <table class="layui-table" lay-size="sm">
                ...
                <#if taxpayerBindRs?? && ( taxpayerBindRs?size gt 0 )>
                    ...
                    <tr>
                        ...
                        <td>${(taxpayerBind.djxh)!}</td>
                        <td>${(taxpayerBind.djrq)!}</td>
                        <td>${(taxpayerBind.shxydm)!}</td>
