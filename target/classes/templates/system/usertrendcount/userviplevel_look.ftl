...
<div class="container-fluid m_top_30 nycol_list  sys_mod">
    <form action="${ctx}/usertrendcount/userviplevel/look.php" method="get" id="consumerListForm" class="layui-form">
        <input type="hidden" name="year" id="year" value="${BaseRq.year!}">
        <input type="hidden" name="doType" id="doType" value="${doType!}">
        <input type="hidden" name="vipCode" id="vipCode" value="${BaseRq.vipCode!}">
