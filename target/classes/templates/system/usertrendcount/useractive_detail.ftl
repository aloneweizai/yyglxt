...
<div class="container-fluid m_top_30 nycol_list  sys_mod">
    <form action="${ctx}/usertrendcount/useractive/info.php?timeInterval=${BaseRq.timeInterval!}" method="get" id="consumerListForm" class="layui-form">
        <input type="hidden" name="timeInterval" id="timeInterval" value="${BaseRq.timeInterval}">
