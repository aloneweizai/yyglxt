...
<div class="container-fluid m_top_30 nycol_list  sys_mod">
    <form action="${ctx}/userimganalyze/usertag.php" method="get" id="consumerListForm" class="layui-form">
        <div class="layui-form-top">
            <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">注册时间</label>
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" id="test6" value="${(BaseRq.startDate)!}" name="startDate" style="width: 185px" >
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label" style="margin-top: 10px">已选标签</label>
                        <div class="layui-input-inline" style="width:400px;margin-right: 20px">
                            <input type="text" name="tagName" id="tagnames" value="${(BaseRq.tagName)!}"
                                  <#-- placeholder="请搜索选择标签"--> class="layui-input" style="height: 45px">
                        </div>
                    </div>
        ...
        <div class="statistics_tab " style="margin-top: 20px;display: none" id="usertag">
            ...
            <div class="tj_statis_w">
                <div class="tj_statis_n hover">
                    <div id="tjday" style="width: 100%;height: 310px"></div>
                </div>
            </div>
...
<script data-main="${ctx}/js/abc/system/usertag.js" src="${ctx}/js/require.js"></script>
</body>
</html>
