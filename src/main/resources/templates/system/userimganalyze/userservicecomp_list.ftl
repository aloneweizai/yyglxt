...
<div class="container-fluid m_top_30 nycol_list  sys_mod">
    <form action="${ctx}/usertrendcount/registerusercount.php" method="get" id="consumerListForm" class="layui-form">
        <div class="layui-form-top">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">绑定时间起</label>
                ...
                <div class="layui-inline">
                    <label class="layui-form-label">绑定时间止</label>
        ...
        <div class="statistics_tab " style="margin-top: 20px;display: none" id="userlook">
...
<script data-main="${ctx}/js/abc/system/userservicecomp.js" src="${ctx}/js/require.js"></script>
</body>
</html>
