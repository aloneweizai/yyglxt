            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" id="startDate">
                        <input type="text" class="layui-input" id="test4" value="${(BaseRq.startDate)!}"
                               name="startDate">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" id="endDate">
                        <input type="text" class="layui-input" id="test5" value="${(BaseRq.endDate)!}" name="endDate">
                    </div>
                </div>
                <div class="layui-inline">
...
<div class="main_modal container-fluid" id="myModal" tabindex="-1" hidden>
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button tyclass="layui-btn layui-btn-primary"btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div>
    </div>
</div>
<script data-main="${ctx}/js/abc/system/userproperty.js" src="${ctx}/js/require.js"></script>
</body>
</html>
