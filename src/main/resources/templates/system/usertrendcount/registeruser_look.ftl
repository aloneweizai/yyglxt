...
<div class="container-fluid m_top_30 nycol_list  sys_mod">
    <form action="${ctx}/usertrendcount/registerusercount/userlook.php?days=${BaseRq.days!}" method="get" id="consumerListForm" class="layui-form">
        <input type="hidden" name="days" id="days" value="${BaseRq.days}">
