...
<div class="container-fluid m_top_30 nycol_list  sys_mod">
    <form action="${ctx}/usertrendcount/usersigntop/list.php" method="get" id="consumerListForm" class="layui-form">
       ...
       <#-- <div class="statistics_tab " style="margin-top: 20px">
            <div class="statistics_t">
                <h3 class="modal-title" style="font-size: large">用户签到排行</h3>
            </div>
        ...
        <div class="nycon_list_b">
            <table class="layui-table" lay-size="sm">
                ...
                <#if userSignTopRs??>
                <tr>
                    <td>${(userSignTopRs.userCount?c)!}</td>
                    <td>${(userSignTopRs.lossUserCount?c)!}</td>
                    <td>${(userSignTopRs.lossUserCount?c)!}</td>
                </tr>
                </#if>
                </tbody>
...
<script data-main="${ctx}/js/abc/system/usersigntop.js" src="${ctx}/js/require.js"></script>
</body>
</html>
