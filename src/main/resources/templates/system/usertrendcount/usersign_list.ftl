...
<div class="container-fluid m_top_30 nycol_list  sys_mod">
    <form action="${ctx}/usertrendcount/usersign/list.php" method="get" id="consumerListForm" class="layui-form">
        ...
        <div class="nycon_list_b">
            <table class="layui-table" lay-size="sm">
                ...
                <tr>
                    ...
                    <th>登录人数（人）</th>
                    <th>
                        签到率 <i class="glyphicon glyphicon-question-sign" title="签到人数/登录人数*100%"></i>
                    </th>
                </tr>
                </thead>
                ...
                <#if userSignRs??>
                <tr>
                    <td>${(userSignRs.userCount?c)!}</td>
                    <td>${(userSignRs.lossUserCount?c)!}</td>
                    <td>${(userSignRs.lossUserCount?c)!}</td>
                    <td>${(userSignRs.rate)!}%</td>
                </tr>
                </#if>
                </tbody>
            </table>
        ...
        <#--<div class="statistics_tab " style="margin-top: 20px">
            <div class="statistics_t">
                <h3 class="modal-title" style="font-size: large">用户签到统计</h3>
            </div>
...
<script data-main="${ctx}/js/abc/system/usersign.js" src="${ctx}/js/require.js"></script>
</body>
</html>
