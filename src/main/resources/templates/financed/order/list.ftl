            ...
            <table class="layui-table" lay-size="sm">
                ...
                <#if orderrs?? && ( orderrs?size gt 0 )>
                    ...
                    <tr>
                        ...
                        <td>
                        <#if canQuery??>
                            <a class="ljc_00bcd4" data-type="opendialog" data-val="4" href="javascript:;" data-url="${ctx}/consumerManager/consumer/info.php?id=${order.userId}">${(order.user.username)!}</a>
                        <#else>
                        ${(order.user.username)!}
                        </#if>
                        </td>
