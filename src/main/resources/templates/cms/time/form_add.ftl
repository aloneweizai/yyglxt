            ...
            <tr>
                ...
                <td colspan="2">
                    <input id="jobName" class="layui-input" style="width:330px;" name="jobName" size="30"
                           type="text"> <span class="color_r2">*</span>
                    ...
                    <div style="width: 330px; float: left">
                        ...
                        <#if jobGroups?? && ( jobGroups?size gt 0 )>
                            <#list jobGroups as jobGroup>
                                <option value="${jobGroup.fieldValue}">${jobGroup.fieldKey}</option>
                            </#list>
                        </#if>
                        </select>
                   <#-- <select name="jobGroup" style="height:30px;" data-type="ajax"
                            data-url="${ctx}/util/jsonDictBOs.php?dictId=jobGroup" data-rules="fieldValue:fieldKey">
                    </select>--></div>
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    温馨提示：表达式支持到七个域(秒分时日月周年），秒分时日月周必须填写，例如最简单的：* * * ? * *这个表达会每秒钟(每分种的、每小时的、每天的)激发一个部署的job，
                     ...
                     <br/>&nbsp;&nbsp;9.# 字符仅能用于周域中。它用于指定月份中的第几周的哪一天，例如，周域的值为 6#3，它意思是某月的第三个周五 。</p>">?</a></span>
                </td>
            </tr>
            <tr>
                <td>任务描述</td>
                <td colspan="2">
                    <textarea style="width: 500px; height: 100px;" id="jobDescription" name="jobDescription"></textarea>
                </td>
            </tr>
            <tr>
                <td>
