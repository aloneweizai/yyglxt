                        ...
                        <div style="float: left" class="layui-form">
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    <input id="date" value="${RequestParameters["date"]!}" type="text" class="layui-input date-item">
                                </div>
                                <div class="layui-btn js_query_day">查找</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <table class="layui-table tables">
                ...
                <#if list?? && (list?size > 0) >
                    ...
                    <tr>
                        ...
                        <td align="center"><a class="ljc_00bcd4 opendialog"  data-val="4" href="javascript:;"
                                              data-url="/cms/courseBrowseWatch/watch_userlist.php?initModule=day&begintime=${(item.updateTime?string("yyyy-MM-dd"))!}&endtime=${(item.updateTime?string("yyyy-MM-dd"))!}&curriculumId=${item.curriculumId!}">${(item.watchNum)!}</a></td>
                        <td align="center">${(item.classify)!}</td>
                        <td align="center">${(item.updateTime?string("yyyy-MM-dd"))!}</td>
                    </tr>
                    </#list>
                </#if>
                </tbody>
