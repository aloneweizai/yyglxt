                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input autocomplete="off" type="text" id="keywords" value="" placeholder="" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
...
<script data-main="${ctx}/js/abc/cms/course/category_tag/list.js?v=${.now?string("yyyyMMddhhmmssSSSS")}" src="${ctx}/js/require.js"></script>
</body>
</html>