...
<div class="container-fluid m_top_30 nycol_list  sys_mod">
    <form action="${ctx}/consumerManager/consumer/toquery.php" method="get" id="consumerListForm" class="layui-form">
           ...
           <#-- <div class="layui-inline">
            ...
            <div class="layui-inline">
                <div class="layui-input-inline" style="width:180px;">
                    <div id="consumer_query" data-val="1" class="layui-btn">查询</div>
            ...
            <#--<div class='moretj' style='display:none;'>
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline"  id="startDate">
                        <input type="text" class="layui-input"   id="test30"  value="${(BaseRq.startDate)!}" name="startDate" readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
            ...
            <table class="layui-table" lay-size="sm">
                ...
                <#if consumers?? && ( consumers?size gt 0 )>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="ljc_00bcd4" data-type="opendialog" data-val="4" href="javascript:;" data-url="${ctx}/consumerManager/consumer/info.php?id=${consumer.id}">
                            ${(consumer.username)!}</a>
                        </td>
                ...
                <tr>
                    <td colspan="11" style="font-size:15px; color: #999;text-align: center">--未查到注册用户信息--</td>
                </tr>
                </#if>
                </tbody>
            </table>
            ...
            <table class="yy_fanye">
                ...
                <tr>
                    <td align="center">
                        ...
                        每页<input maxlength="2" style="width:40px" name="size" value="${BaseRq.size}" id="consumer_size"data-val="1" type="text">条&nbsp;&nbsp;
                        <input class="btn btn-default btn-xs"  value="首 页" id="consumer_first"data-val="1" type="button" >
                        <input class=" btn btn-default btn-xs" value="上一页" id="consumer_up" data-val="1" type="button">
                        <input class=" btn btn-default btn-xs" value="下一页" id="consumer_down" data-val="1"type="button">
                        <input class=" btn btn-default btn-xs" value="尾 页" id="consumer_last" data-val="1"type="button">&nbsp;&nbsp;
                        当前&nbsp;${(BaseRq.page?c)!}/${(BaseRq.totalPage?c)!}&nbsp;页&nbsp;&nbsp;转到第
                        <input style="width:50px" onfocus="this.select();" id="consumer_go" value="${(BaseRq.page?c)!}" type="text"> 页
                        <input class=" btn btn-default btn-xs" value="转" id="consumer_gogo" data-val="1"type="button">
