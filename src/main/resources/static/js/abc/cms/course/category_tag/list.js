...
require(["../../../../config"], function () {
    require(["jquery-3.1.0","../abc/cms/course/category","abc.common","layui"], function ($, category) {
        ...
        var ajaxListByCategory = function(){
            ...
            if(categoryCode == 0 || vategoryPCode==0 ){
                ...
                $.ajax({
                    url: ctx + "/cms/course/cateTag/ajaxList.php?classifyId="+categoryCode,
                    type: "get",
        ...
        $('body').on('click', '.js_save_categoryTag_btn', function(e){
            ...
            var obj={classifyId:categoryCode, classifyName:categoryName, tagList:tagList};
            $.ajax({
                type: "post",
                url: ctx + "/cms/course/cateTag/modify.php",
        ...
        $('body').on('click', '.js_add_tag', function(e){
            e.preventDefault();
            showContentLayer('添加标签', 400, 230, 200, $("#addTag_pop"));
        });
        //open弹窗公共方法
        ...
        $('body').on('click', '.js_submit_tag', function(e){
            ...
            $.ajax({
                url: ctx + "/cms/knowTag/addByOtherChannel.php?tagType=xthf_course",
                type: "POST",
