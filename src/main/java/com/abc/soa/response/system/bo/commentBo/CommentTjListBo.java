 ...
 */
public class CommentTjListBo extends BaseResponse {

    private Integer days;//今日评论
    private Integer weeks;//本周评论数
    private Integer months;//本月评论数
    private Integer years;//本年评论数
    private Integer cnts;//总评论数
    private List<CommentTjBo> tjday;//日统计全部评论
    private List<CommentTjBo> tjday0;//日统计未回复
    private List<CommentTjBo> tjday1;//日统计已回复
    private List<CommentTjBo> tjmonth;//月统计全部评论
    private List<CommentTjBo> tjmonth0;//月统计未回复
    private List<CommentTjBo> tjmonth1;//月统计已回复
    private List<CommentTjBo> tjyear;//年统计全部评论
    private List<CommentTjBo> tjyear0;//年统计未回复
    private List<CommentTjBo> tjyear1;//年统计已回复
