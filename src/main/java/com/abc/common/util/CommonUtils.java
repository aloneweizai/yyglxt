...
//            is.close();
     ...
     * @return
     */
    public static String getPhoneBluring(String phone){
        StringBuilder phoneFuffer = new StringBuilder(phone);
        phone = phoneFuffer.replace(3, phone.length() - 4, "****").toString();
       return phone;
    }
...
/// <returns>被特殊字符替换的字符串</returns>
    public static String replaceWithSpecialChar(String value, int startLen, int endLen, String specialChar)
    {
            int lenth = value.length()  - endLen;
